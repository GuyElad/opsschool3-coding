"""
Guy home assignment 1 in coding 1 session 1

Read input from json file format
List of people divided to buckets based on their ages
Write output to yaml file format
"""
